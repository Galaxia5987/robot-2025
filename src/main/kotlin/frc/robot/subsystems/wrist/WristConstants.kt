...
val ALMOST_AT_SETPOINT_TOLERANCE: Angle = Units.Degrees.of(10.0)
...
val RESET_VOLTAGE: Voltage = Units.Volts.of(-10.0)
...
enum class Angles(val angle: Angle) {
    ...
    ALIGN_L4(Units.Degrees.of(125.0)),
    ...
    FLOOR_ALGAE(Units.Degrees.of(65.0)),
    FLOOR_ALGAE_END(Units.Degrees.of(55.0)),
