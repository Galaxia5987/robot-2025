...
val ALIGNMENT_X_GAINS = Gains(2.0, 0.0, 0.3)
val ALIGNMENT_Y_GAINS = Gains(4.0, 0.0, 0.0)
val ALIGNMENT_ROTATION_GAINS = Gains(2.0, 0.0, 0.0)

val ALIGNMENT_Y_VELOCITY: LinearVelocity = Units.MetersPerSecond.of(0.5)
