...
//val ReefFaceLeft: Pose2d = Pose2d(3.23, 4.22, Rotation2d.kZero)
...
val Reef5Left: Pose2d =
    Reef4Left.rotateAround(ReefCenter, Rotation2d.fromDegrees(60.0)).plus(Transform2d(0.0, -1.0, Rotation2d.kZero))
